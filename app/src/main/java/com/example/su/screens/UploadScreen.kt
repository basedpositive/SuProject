        ...
        Column(
            ...
            if (user != null) {
                ...
                Column(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        Text("Для загрузки видео войдите в систему", style = MaterialTheme.typography.bodyMedium)
                    }
                    Spacer(modifier = Modifier.height(8.dp))
                    Canvas(modifier = Modifier
                        .fillMaxWidth()
                    ...
                    Spacer(modifier = Modifier.height(8.dp))
                    Button(onClick = { navController.navigate("registration") }, modifier = Modifier.fillMaxWidth()) {
